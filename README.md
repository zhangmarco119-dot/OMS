...
StoreHub V2 当前只完成阶段 0/1：V1 兼容审计、角色边界、功能开关、门店到货入口和管理员到货卡片骨架。到货数据库、图片上传和正式提交尚未实现，详见 [V2 阶段 0/1 审计与设计草案](docs/V2_PHASE_0_1_AUDIT.md)。
...
V1 阶段 9 已完成。V2 当前停在阶段 1；下一步只能在确认后进入阶段 2 数据库与 Storage 实施。
