...
StoreHub V2 当前完成阶段 0–4：V1 兼容审计、角色边界、到货数据库/RLS/私有 Storage、门店端到货上报，以及管理员消息、列表、详情、作废、每日汇总和 Excel。详见 [V2 阶段 4 管理员到货中心](docs/V2_PHASE_4_ADMIN_ARRIVALS.md)。
...
V1 阶段 9 已完成。V2 当前停在阶段 4；下一步只能在确认后进入阶段 5 任务模板、周清和巡店。
