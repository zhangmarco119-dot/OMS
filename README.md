...
StoreHub V2 当前完成阶段 0–7：已支持到货闭环、版本化任务模板、门店任务执行、管理员审核整改，以及按门店和角色隔离的公告与 SOP。详见 [V2 阶段 7](docs/V2_PHASE_7_NOTICES_AND_SOPS.md)。
...
V1 阶段 9 已完成。V2 当前停在阶段 7；下一步只能在确认后进入阶段 8 统计和历史中心增强。
