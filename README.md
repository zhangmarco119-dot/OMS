...
StoreHub V2 当前完成阶段 0/1 和阶段 2：V1 兼容审计、角色边界、功能开关、到货入口，以及到货数据库、RLS、私有 Storage Policy 和类型。门店草稿、图片上传和前端提交尚未实现，详见 [V2 阶段 2 数据库说明](docs/V2_PHASE_2_DATABASE.md)。
...
V1 阶段 9 已完成。V2 当前停在阶段 2；下一步只能在确认后进入阶段 3 门店端到货上报。
