...
const requiredFunctions = [
  ...
  'match_recent_arrival_items_for_product',
  'get_product_matching_settings',
  'admin_save_product_matching_settings',
  'list_recommended_product_additions',
  'admin_create_recommended_products',
