...
const detail: AttendanceMonthDetail = {
  summary: { attendanceDates: ['2026-07-14', '2026-07-15'], attendanceDays: 2, workedMinutes: 1050, lateCount: 1, lateMinutes: 12, missingCount: 0, abnormalCount: 0, lastSyncedAt: '2026-07-15T02:00:00Z' },
  days: [
...
describe('AttendanceMonthView', () => {
  it('shows summary, enterprise-timezone punches and a focused exception list', () => {
    ...
    expect(screen.getByText('17.5 小时')).toBeInTheDocument();
  ...
  it('identifies the missing punch and shows a fieldwork badge', () => {
    render(<AttendanceMonthView detail={{
      summary: { attendanceDates: ['2026-07-16'], attendanceDays: 1, workedMinutes: 480, lateCount: 0, lateMinutes: 0, missingCount: 1, abnormalCount: 0, lastSyncedAt: null },
