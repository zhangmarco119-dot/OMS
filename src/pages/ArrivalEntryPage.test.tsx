...
describe('ArrivalEntryPage role boundary', () => {
  ...
  it('keeps the submission confirmation above the bottom navigation', () => {
    ...
    setReadyDraft({
      ...
      images: [
        { bucket: 'arrival-report-images', created_at: '2026-07-13T15:59:00Z', file_name: 'waybill.jpg', height: 100, id: '00000000-0000-4000-8000-000000000401', image_type: 'waybill', mime_type: 'image/jpeg', object_path: 'waybill.jpg', report_id: '00000000-0000-4000-8000-000000000301', signedUrl: 'https://example.com/waybill.jpg', size_bytes: 100, store_id: '00000000-0000-4000-8000-000000000101', uploaded_by: '00000000-0000-4000-8000-000000000001', width: 100 },
        { bucket: 'arrival-report-images', created_at: '2026-07-13T15:59:00Z', file_name: 'goods.jpg', height: 100, id: '00000000-0000-4000-8000-000000000402', image_type: 'goods', mime_type: 'image/jpeg', object_path: 'goods.jpg', report_id: '00000000-0000-4000-8000-000000000301', signedUrl: 'https://example.com/goods.jpg', size_bytes: 100, store_id: '00000000-0000-4000-8000-000000000101', uploaded_by: '00000000-0000-4000-8000-000000000001', width: 100 },
      ],
    });
