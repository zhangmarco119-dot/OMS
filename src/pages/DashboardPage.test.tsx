...
describe('DashboardPage administrator payroll cost', () => {
  beforeEach(() => {
    ...
    vi.mocked(loadTodoSummary).mockResolvedValue({ count: 0, payrollConfirmations: 0, noticeAcknowledgements: 0, productCreationRequests: 0, productFeedback: 0, tasks: 0, overtime: 0, attendanceCorrections: 0, arrivalCorrections: 0, payrollPayslips: 0 });
