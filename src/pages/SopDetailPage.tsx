...
export function SopDetailPage() {
  ...
  const [publishSettings, setPublishSettings] = useState<PublishSettings>({ effectiveAt: '', roles: ['staff', 'manager'], silent: true, storeIds: [] });
  ...
  const confirmPublish = async () => {
    ...
    try {
      await saveSop(client, {
        ...
        taskTemplateId: sop.taskTemplateId,
        title: sop.title,
      });
