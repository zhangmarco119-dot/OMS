...
import { asTaskItemSnapshot, loadV2TaskDetail, loadV2TaskImageUrls, saveV2TaskProgress, submitV2Task, uploadV2TaskImage, type V2TaskAnswerRow, type V2TaskDetail, type V2TaskImageRow } from '../services/v2-tasks.service';
...
function AnswerCard({ answer, editable, images, imageUrls, needsCorrection, onChange, onUpload }: { answer: V2TaskAnswerRow; editable: boolean; images: V2TaskImageRow[]; imageUrls: Record<string, string>; needsCorrection: boolean; onChange: (value: Json) => void; onUpload: (file: File | undefined) => void }) {
  const item = asTaskItemSnapshot(answer.item_snapshot);
