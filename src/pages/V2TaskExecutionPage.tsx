...
function AnswerCard({ answer, editable, images, imageUrls, onChange, onUpload }: { answer: V2TaskAnswerRow; editable: boolean; images: V2TaskImageRow[]; imageUrls: Record<string, string>; onChange: (value: Json) => void; onUpload: (file: File | undefined) => void }) {
  const item = asTaskItemSnapshot(answer.item_snapshot);
