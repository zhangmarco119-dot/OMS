  ...
  public: {
    Tables: {
      ...
      payroll_employee_rules: {
        Row: { commission_enabled: boolean; commission_rate: number | null; confirmed: boolean; created_at: string; created_by: string | null; effective_from: string; effective_to: string | null; full_attendance_bonus_amount: number; full_attendance_bonus_enabled: boolean; full_performance_amount: number | null; housing_enabled: boolean; id: string; monthly_base_salary: number; monthly_housing_allowance: number; performance_enabled: boolean; profile_id: string; change_reason: string; regularization_date: string | null; service_award_amount: number; service_award_enabled: boolean };
        Insert: { commission_enabled?: boolean; commission_rate?: number | null; confirmed?: boolean; created_at?: string; created_by?: string | null; effective_from: string; effective_to?: string | null; full_attendance_bonus_amount?: number; full_attendance_bonus_enabled?: boolean; full_performance_amount?: number | null; housing_enabled?: boolean; id?: string; monthly_base_salary: number; monthly_housing_allowance?: number; performance_enabled?: boolean; profile_id: string; change_reason: string; regularization_date?: string | null; service_award_amount?: number; service_award_enabled?: boolean };
        Update: { commission_enabled?: boolean; commission_rate?: number | null; confirmed?: boolean; created_at?: string; created_by?: string | null; effective_from?: string; effective_to?: string | null; full_attendance_bonus_amount?: number; full_attendance_bonus_enabled?: boolean; full_performance_amount?: number | null; housing_enabled?: boolean; id?: string; monthly_base_salary?: number; monthly_housing_allowance?: number; performance_enabled?: boolean; profile_id?: string; change_reason?: string; regularization_date?: string | null; service_award_amount?: number; service_award_enabled?: boolean };
        Relationships: [];
      };
